...
export default function ErrorBoundary({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="py-12 flex flex-col items-center justify-center text-center">
      <h2 className="font-serif text-2xl text-[#E8E6E0] mb-2">The void shifts unexpectedly.</h2>
      <p className="font-serif text-lg italic text-[#C41E1E] mb-6">{error.message}</p>
      <button 
        onClick={reset} 
